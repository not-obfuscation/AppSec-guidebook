...
План (`/home/tarchok/Obsidian Vault/AppSec-engineer/plan.md.md`) — источник
...
PLAN_PATH = Path("/home/tarchok/Obsidian Vault/AppSec-engineer/plan.md.md")

# План лежит вне репозитория, на машине автора. Значит везде, где репозиторий
# проверяется без неё — в CI прежде всего, — плана нет и не будет. Проверки,
# которым он нужен, обязаны это заметить и сказать вслух, а не падать
# трассировкой и не молчать: см. `plan_missing_note()`.
