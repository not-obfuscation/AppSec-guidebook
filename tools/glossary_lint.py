...
# Блок 14 «Источники» канона части 4 — сплошь чужие заглавия: «Cross-Origin
# Resource Sharing (CORS)», «Session ID Properties», «Introspection». Заглавие
# цитируется буквально (7.4), поэтому канон написаний на него не распространяется.
SOURCES_RE = re.compile(r"^##\s*14\.\s", re.M)
...
# Блоки 13 «Дальше» и 14 «Источники» канона части 4 говорят не о материале
# страницы, а о других страницах и о чужих документах. Аббревиатура в указателе
...
MATERIAL_END_RE = re.compile(r"^##\s*13\.\s", re.M)
