...
FIX_PY = [
    ...
    "jwt-attacks", "jwt-basics", "oauth-basics", "os-command-injection",
    "parameterized-queries", "password-storage", "path-traversal",
    "privilege-escalation-vertical", "race-conditions", "sqli-basics",
    "ssrf-basics",
]
