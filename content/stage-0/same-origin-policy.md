...
встроить чужой ресурс. Эти границы в обе стороны правят три механизма: CORS
(Cross-Origin Resource Sharing), CSP (Content Security Policy) и
cookie-атрибуты. Все три стоят поверх этой модели и без неё не читаются.
