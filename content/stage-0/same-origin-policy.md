...
свободно. Статья web.dev приводит ровно этот случай: сайт из интернета читает
чужую веб-почту, в которую вы вошли, или страницу корпоративной сети, куда
...
модель cookie — по документации (MDN, открыта лично 2026-08-22); пример с
чужой веб-почтой и корпоративной сетью — по статье web.dev «Same-origin
policy». Требования
