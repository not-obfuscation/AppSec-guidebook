...
что вы спросите следом: где проверяется подпись, что происходит при выходе, какие
алгоритмы приняты.
...
снаружи выглядят одинаково. Разница видна в одном месте: когда доступ надо отнять до
срока.
