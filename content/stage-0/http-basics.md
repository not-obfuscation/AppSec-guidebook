...
Уровень **L2** · время 25 мин (теория 12 / задача 8 / самопроверка 5,
оценка)
...
браузера или проверка ссылок обходит все адреса подряд.
...
лично 2026-08-22). Ни один пример не запускался: стенда под рукой не было.
