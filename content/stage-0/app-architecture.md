...
самопроверка 5, оценка) · reviewed: 2026-08-23 · проверено на: web.dev
«Rendering on the Web» (правка 5 января 2026), MDN «Proxy servers and
tunneling» (правка 9 ноября 2025) и «CORS errors» (правка 23 марта 2026),
RFC 7239 (июнь 2014), RFC 9111 (STD 98, июнь 2022), CWE 4.20
...
до этого ссылался на MDN, не назвав её. Норма задаёт нижнюю границу и верхней
не имеет (`PLAYBOOK.md` 11.2 пункт 8).
...
лично 2026-08-23). Цепочка узлов не разбиралась на живой системе: стенда у
миссии нет.
