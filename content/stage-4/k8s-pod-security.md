...
же под с privileged: true запустился и работает. Это и есть тема: профили
...
Ревьюер читает манифест пода и метку пространства. Два образца:
