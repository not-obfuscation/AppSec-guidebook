...
никто ничего не объявил. Вопрос задаётся коду, а не документации. Не заглядывая
в выноски, проследите сами, каким путём запрос к `/admin/export` проходит мимо
охраны, — и назовите строку, где он мог бы остановиться.
