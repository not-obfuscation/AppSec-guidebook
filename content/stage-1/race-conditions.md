...
что между чтением и записью состояние успевает измениться. Арифметика
верная, итог неверный.
...
Ревьюер ищет форму «прочитал, посчитал у себя, записал обратно». До чтения
выносок отметьте, какие строки образуют окно.
...
**Тот же дефект на другом стеке.** В Node на любой ORM
(object-relational mapping) он выглядит так же:
